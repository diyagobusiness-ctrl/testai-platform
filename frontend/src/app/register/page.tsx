      ...
      >
        <div className="rounded-2xl border border-border bg-card/80 p-8 shadow-xl backdrop-blur-lg">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground">Join TestAi and start your learning journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="John"
                    className="w-full rounded-xl border border-border bg-background py-3 pl-10 pr-4 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-200"
                  />
                </div>
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder="Doe"
                  className="w-full rounded-xl border border-border bg-background py-3 px-4 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-200"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-border bg-background py-3 pl-10 pr-12 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-200"
                />
                <button
                  type="button"
            ...
            <ButtonGlow type="submit" className="w-full" disabled={isLoading}>
